...
export const UserList: React.FC<UserListProps> = ({ 
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-[2rem] shadow-sm border border-slate-100 dark:border-slate-800 flex flex-col h-[700px] overflow-hidden transition-colors">
      <div className="p-6 border-b border-slate-50 dark:border-slate-800 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex bg-slate-100 dark:bg-slate-800 rounded-xl p-1 text-[10px] font-bold uppercase tracking-widest">
            <button 
        ...
        <div className="flex gap-2">
          ...
          <button className="p-3 bg-slate-50 dark:bg-slate-800 border border-slate-50 dark:border-slate-700 rounded-2xl text-slate-400 dark:text-slate-500 hover:text-varsity-navy dark:hover:text-varsity-gold transition-all">
