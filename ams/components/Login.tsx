...
import { Lock, LogIn, GraduationCap, Sun, Moon, Eye, EyeOff } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4 font-sans transition-colors duration-300">
      ...
      <button 
        ...
        className="fixed top-6 right-6 p-3 bg-white dark:bg-slate-900 text-slate-400 dark:text-slate-500 hover:text-varsity-navy dark:hover:text-varsity-gold rounded-2xl transition-all border border-slate-100 dark:border-slate-800 shadow-xl"
      >
      ...
      <div className="fixed bottom-6 text-slate-300 dark:text-slate-700 text-[10px] font-bold uppercase tracking-widest">
